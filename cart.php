        ...
        <div>
            ...
            <div class="container">
                <table class="table table-bordered table-striped">
                    <tbody>
                        <tr>
                            <th>Številka izdelka</th><th>Ime izdelka</th><th>Cena</th><th></th>
                        </tr>
                       <?php 
                        $user_products_result=mysqli_query($con,$user_products_query) or die(mysqli_error($con));
                        $no_of_user_products= mysqli_num_rows($user_products_result);
                       ...
                       while($row=mysqli_fetch_array($user_products_result)){
                        ...
                        <tr>
                            ...
                            <th><a href='cart_remove.php?id=<?php echo $row['id'] ?>'>Odstrani</a></th>
                        </tr>
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Skupaj</th><th>€ <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Potrdi naročilo</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
